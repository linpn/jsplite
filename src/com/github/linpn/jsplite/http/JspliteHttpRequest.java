package com.github.linpn.jsplite.http;
 ...
 * @author Linpn
 */
public class JspliteHttpRequest extends HttpServletRequestWrapper implements HttpServletRequest {

    private HttpServletRequest request;

    public JspliteHttpRequest(HttpServletRequest request) {
        super(request);
